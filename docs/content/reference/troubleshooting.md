...
Most of these come down to network reality or how dockerhub serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

dockerhub rate-limits like any public site. dhub already paces
...
Where a surface is gated, dhub reads a cookie or token you supply
...
`dhub`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what dhub actually did
